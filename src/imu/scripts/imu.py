...
def imu_publisher():
    ...
    while not rospy.is_shutdown():
        ...
        #odom_broadcaster.sendTransform((0.0,0.0,0.0), quaternion, current_time, "base_link", "odom")
        ...
        #rospy.loginfo("Quaternion.x %f", quaternion[0])
        ...
        rospy.loginfo("Deg: Angular vel z: %f", math.degrees(imu.angular_velocity.z))
        rospy.loginfo("Rad: Angular vels x %f\t y %f\t z %f\t", imu.angular_velocity.x, imu.angular_velocity.y, imu.angular_velocity.z) 
